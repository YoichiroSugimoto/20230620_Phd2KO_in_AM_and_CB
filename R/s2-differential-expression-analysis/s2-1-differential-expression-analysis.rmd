...
Only analyse WT cells.

```{r tissue differences}
...
dds.tissue2 <- DESeq(
    dds.tissue2,
    test = "LRT", # Added on 20230611
    reduced = ~ 1 # Added on 20230611
)
...
# Export the results of all analysis


```{r plot the results of all analysis}
